...
class UserModel(db.Model):
    ...
    def __init__(self, username, password):
        # we don't need to create id by ourselves because when we create an object through SQLAlchemy it will generate id and give us automatically
        # self.id = _id 
    ...
    # actually following 2 methods can be seen as API
    @classmethod
